...
export class MessageSender extends React.Component {
  public state = {
    username: readRecord("username") || "DemoName",
    chatMessage: "",
  };
  ...
  private getTime = (): string => {
    return readRecord("clockMode") === "12"
      ? getTime12Hours()
      : getTime24hours();
  };
}
...
): IMessageSenderDispatchProps => ({
  sendMessage: (message: { from: string; content: string; time: string }) =>
